...
export default function Contact() {
  ...
  const contacts = [
    ...
    },
    {
      ...
      label: 'VKontakte',
      value: 'painmylive',
      href: 'https://m.vk.com/painmylive',
    ...
    <section id="contact" ref={sectionRef} className="py-20 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {contacts.map((contact, index) => (
              <a
                ...
                className={`group border border-gray-700 rounded-lg p-8 hover:border-white transition-all duration-500 transform hover:scale-105 ${
                  isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                }`}
          ...
          {/* Call to Action */}
          <div className={`border border-gray-700 rounded-lg p-8 transform transition-all duration-1000 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
